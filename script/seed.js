...
async function seed() {
  ...
  const messages = await Promise.all([
    ...
    Message.create({ content: "Can't wait to see you guys!!", tripId: friday.id, sentById: jason.id, dateSent: '2022-01-07T09:13:34.000Z' }),
    Message.create({ content: "I miss prof :( ", tripId: friday.id, sentById: stanley.id, dateSent: '2022-01-07T09:16:34.000Z' }),
    Message.create({ content: "Don't worry, I'll be there!", tripId: friday.id, sentById: prof.id, dateSent: '2022-01-07T11:25:34.000Z' }),
  ])
