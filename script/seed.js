...
async function seed() {
  ...
  const userTrips = await Promise.all([
    UserTrip.create({ userId: andy.id, tripId: nyc.id, status: 'accepted' }),
    UserTrip.create({ userId: andy.id, tripId: charlotte.id, status: 'accepted' }),
    UserTrip.create({ userId: andy.id, tripId: miami.id, status: 'accepted' }),
    UserTrip.create({ userId: corinne.id, tripId: nyc.id, status: 'accepted' }),
    UserTrip.create({ userId: corinne.id, tripId: miami.id, status: 'accepted' }),
    UserTrip.create({ userId: corinne.id, tripId: paris.id, status: 'accepted' }),
    UserTrip.create({ userId: jonathan.id, tripId: charlotte.id, status: 'accepted' }),
    UserTrip.create({ userId: jonathan.id, tripId: miami.id, status: 'accepted' }),
    UserTrip.create({ userId: jonathan.id, tripId: paris.id, status: 'accepted' }),
    UserTrip.create({ userId: jason.id, tripId: paris.id, status: 'accepted' }),
    UserTrip.create({ userId: jason.id, tripId: friday.id, status: 'accepted' }),
    UserTrip.create({ userId: jonathan.id, tripId: friday.id, status: 'accepted' }),
    UserTrip.create({ userId: corinne.id, tripId: friday.id, status: 'accepted' }),
    UserTrip.create({ userId: andy.id, tripId: friday.id, status: 'accepted' }),
    UserTrip.create({ userId: stanley.id, tripId: friday.id, status: 'accepted' }),
    UserTrip.create({ userId: stanley.id, tripId: nye.id, status: 'accepted' }),
    UserTrip.create({ userId: andy.id, tripId: nye.id, status: 'accepted' }),
  ])
